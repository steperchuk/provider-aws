...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1beta1.ProvisionedProduct_GroupVersionKind.String())
	...
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1beta1.ProvisionedProduct_GroupVersionKind),
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["aws_servicecatalog_provisioned_product"],
			tjcontroller.WithCallbackProvider(tjcontroller.NewAPICallbacks(mgr, xpresource.ManagedKind(v1beta1.ProvisionedProduct_GroupVersionKind))),
		)),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1beta1.ProvisionedProduct{}).
